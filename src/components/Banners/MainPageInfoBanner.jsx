      ...
      {showBanner ? (
        <aside>
          ...
          <SpanInfo>
            ...
            Catch this rare interview with the "Father of the Crypto
            Revolution," J. Christopher Giancarlo, who cautions against rushing
            into creating a digital dollar! Read it here.
          </SpanInfo>
          {/* </BannerContent> */}
          {/* <BannerOption> */}
