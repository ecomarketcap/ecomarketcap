...
export default function CoinPageHeader(props) {
  ...
  return (
    <header className='row mt-3 mb-3' style={colorStyle}>
      <div className='col-3'>
        <Plogo>
          <img src={props.coinInfo.image.small} alt='' />
        </Plogo>
        <P>
        ...
        <P>
          ...
          <SpanData>
            {Format.toCurrencyNDigits(
              props.coinInfo.market_data.price_change_percentage_24h,
              'USD',
              5
            )}
          </SpanData>
        ...
        <P>
          ...
          <SpanData>
            {Format.toCurrencyNDigits(
              props.coinInfo.market_data.total_volume.usd,
              'USD',
              0
            )}
          </SpanData>
      ...
      <div className='col-9'>
        <div className='row'>
          <div className='col-6'>
            <div className='row'>
              <H1>
                <SpanName>{props.coinInfo.name}</SpanName>
                <SpanSymbol>{props.coinInfo.symbol}</SpanSymbol>
              </H1>
            </div>
            <div className='row justify-content-between'>
              <P>
                ...
                <SpanData>
                  {Format.toCurrencyNDigits(
                    props.coinInfo.market_data.high_24h.usd,
                    'USD',
                    2
                  )}
                </SpanData>
              ...
              <P>
                ...
                <SpanData>
                  {Format.toCurrencyNDigits(
                    props.coinInfo.market_data.low_24h.usd,
                    'USD',
                    2
                  )}
                </SpanData>
            ...
            <div className='row justify-content-between'>
              <P>
                ...
                <SpanData>
                  {props.coinInfo.market_data.current_price.usd}
                </SpanData>
              </P>
              <P>
                <SpanLabel>Price (btc) :</SpanLabel>
                <SpanData>
                  {props.coinInfo.market_data.current_price.btc}
                </SpanData>
              </P>
              <P>
                <SpanLabel>Price (eth) :</SpanLabel>
                <SpanData>
                  {props.coinInfo.market_data.current_price.eth}
                </SpanData>
              </P>
            </div>
          </div>
          <div className='col-5 ml-2'>
            <div className='row my-3'>
              <P>
                ...
                <SpanData>
                  {Format.toLocale(props.coinInfo.market_data.total_supply)}
                </SpanData>
              </P>
              <P>
                ...
                <SpanData>
                  {Format.toLocale(
                    props.coinInfo.market_data.circulating_supply
                  )}
                </SpanData>
              </P>
            </div>
            ...
            <div className='row'>
              <P>
                ...
                <SpanData>
                  {props.coinInfo.categories.map((cat, index) => {
                    if (index > 0 && cat !== '') {
                      return ', ' + cat;
                    } else {
                      return cat;
