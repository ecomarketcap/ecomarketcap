...
export default function MarketBannerMainPage(props) {
  ...
  const fetchGlobalInfos = () => {
    ...
    props.refreshUpdateTime(
      Time.fromTimestamp(globalInfos.paprikaInfos.last_updated)
    );
  };
  ...
  const newUpdateTime = props.lastUpdateTime
    ? props.lastUpdateTime
    : Time.fromTimestamp(globalInfos.paprikaInfos.last_updated);

  return (
    <>
      <Aside style={colorStyle}>
        {/* <BannerContent> */}
        {loading ? (
          loader
        ) : (
          <Ul className={divUlClass}>
            <Li key='MB1' className={divLiClass}>
              ...
              <span className={content}>
                {' ' + globalInfos.paprikaInfos.cryptocurrencies_number}
              </span>
            </Li>
            ...
            <Li key='MB3' className={divLiClass}>
              <span>Markets :</span>
              <span className={content}>
                {' ' + globalInfos.geckoInfos.markets}
              </span>
            </Li>
            ...
            <Li key='MB5' className={divLiClass}>
              ...
              <span className={content}>
                {' ' +
                  Format.toCurrency(
                    globalInfos.paprikaInfos.market_cap_usd,
                    'USD'
                  )}
              </span>
            </Li>
            ...
            <Li key='MB7' className={divLiClass}>
              ...
              <span className={content}>
                {' ' +
                  globalInfos.geckoInfos.market_cap_change_percentage_24h_usd}
              </span>
            </Li>
            ...
            <Li key='MB9' className={divLiClass}>
              ...
              <span className={content}>
                {' ' +
                  Format.toCurrency(
                    globalInfos.paprikaInfos.volume_24h_usd,
                    'USD'
                  )}
              </span>
            </Li>
            ...
            <Li key='MB11' className={divLiClass}>
              ...
              <span className={content}>
                {' ' +
                  globalInfos.paprikaInfos.bitcoin_dominance_percentage +
                  '%'}
              </span>
            </Li>
            ...
            <Li key='MB13' className={divLiClass}>
              ...
              <span className={content}>{' ' + newUpdateTime}</span>
            </Li>
          </Ul>
        )}
        {/* </BannerContent> */}
